    ...
    <div className="h-full flex">
      <div className="flex w-full flex-col">
        <div className="flex flex-col h-full overflow-y-auto p-4">
          ...
          {/* Start Half Circle */}
          <div className="relative top-0 left-1/2 w-[1.375rem] h-8 -translate-x-1/2 rounded-t-full border-t-[0.2rem] border-l-[0.2rem] border-r-[0.2rem] border-primary shrink-0"></div>

          <div className="flex w-full justify-between flex-1 overflow-y-auto relative">
            {/* First direction */}
                ...
                (service) =>
                  ...
                  (!isSharedLastStop ||
                    ...
                    <div
                      ...
                      className="hover:bg-accent/50 rounded-lg transition-colors duration-300 pr-5 py-4 relative after:absolute after:top-0 after:right-0 after:w-[0.2rem] after:h-full after:bg-primary after:translate-x-[-0.5rem] before:absolute before:top-1/2 before:right-0 before:w-2 before:h-2 before:border-t-2 before:border-r-2 before:border-foreground before:z-10 before:translate-x-[-0.35rem] before:-translate-y-1/2 before:rotate-[135deg] flex flex-col justify-center"
                    >
              ...
              {[...direction2Services].reverse().map(
                (service) =>
                  ...
                  (!isSharedLastStop ||
                    ...
                    <div
                      key={`${service.id}-${service.stop_id}-${service.sequence}`}
                      className="hover:bg-accent/50 rounded-lg transition-colors duration-300 pl-5 py-4 relative after:absolute after:top-0 after:left-0 after:w-[0.2rem] after:h-full after:bg-primary after:translate-x-[0.5rem] before:absolute before:top-1/2 before:left-0 before:w-2 before:h-2 before:border-t-2 before:border-r-2 before:border-foreground before:z-10 before:translate-x-[0.35rem] before:rotate-[-45deg] flex flex-col justify-center"
                    >
          ...
          {/* Ending Half Circle */}
          <div className="relative top-0 left-1/2 w-[1.375rem] h-8 -translate-x-1/2 rounded-b-full border-b-[0.2rem] border-l-[0.2rem] border-r-[0.2rem] border-primary shrink-0"></div>
